...
The Vercel build includes only generated demo fixtures. It omits the external news directory and disables fetching external articles in the repository. Real gatherers remain local tools. The intended production alias is `sor-demo.vercel.app`; assign it to this project in Vercel Domains.
